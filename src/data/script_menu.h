...
static const struct MenuAction MultichoiceList_PokemonChoice[] =
{
    {gText_PokemonChoice1},
    {gText_PokemonChoice2},
    {gText_Choice3},
};
...
static const struct MultichoiceListStruct sMultichoiceLists[] =
{
    ...
    [MULTI_POKEMON_CHOICE]             = MULTICHOICE(MultichoiceList_PokemonChoice),
};
